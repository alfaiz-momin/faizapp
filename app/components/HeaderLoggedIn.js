...
function HeaderLoggedIn(props) {
  ...
  return (
    <div className="flex-row my-3 my-md-0">
      ...
      <Link data-tooltip-id="profilePic" data-tooltip-content="My Profile" to={`/profile/${appState.user.username}`} className="mr-2">
        <img className="small-header-avatar" src={appState.user.avatar} />
      </Link>
      <ReactTooltip place="bottom" id="profilePic" className="custom-tooltip" />{" "}
